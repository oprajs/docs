 ...
 * @class ComplexType
 */
class ComplexTypeClass extends data_type_js_1.DataType {
                ...
                if (i < len) {
                    ...
                    if (field) {
                        ...
                        if (dataType && !dataType.additionalFields) {
                            if (silent)
                                return { done: true, value: [] };
                            throw new Error((0, index_js_2.translate)('error:UNKNOWN_FIELD', { field: curPath }));
                        }
                    }
                }
                return {
    ...
    exportSchema(options) {
        ...
        Object.assign(out, (0, index_js_1.omitUndefined)({
            ...
            additionalFields: this.own.additionalFields instanceof data_type_js_1.DataType
