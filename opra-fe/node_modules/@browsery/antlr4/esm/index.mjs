import { p as process } from './process-xFtGgf45.mjs';
...
//
    ...
    actionTransition(config, t) {
        if (this.debug) {
            t.actionIndex === -1 ? 65535 : t.actionIndex;
        }
        return new ATNConfig({state:t.target}, config);
    }
    ...
    getTokenName(t) {
        ...
        if( this.parser!==null && this.parser.literalNames!==null) {
            if (t >= this.parser.literalNames.length && t >= this.parser.symbolicNames.length) ; else {
        ...
        for(let i=0; i<decs.length; i++) {
            ...
            if (c.state.transitions.length>0) {
                ...
                if (t instanceof AtomTransition) {
                    "Atom "+ this.getTokenName(t.label);
    ...
    addDFAEdge(dfa, from_, t, to) {
        ...
        if (this.debug) {
            this.parser===null ? null : this.parser.literalNames;
...
var atn = { ATN, ATNDeserializer, LexerATNSimulator, ParserATNSimulator, PredictionMode, PredictionContextCache };
...
var Utils = { arrayToString, stringToCharArray };
...
var index_web = {
    atn, dfa, context, misc, tree, error, Token, CommonToken, CharStreams, CharStream: InputStream, InputStream, CommonTokenStream, Lexer, Parser,
    ParserRuleContext, Interval, IntervalSet, LL1Analyzer, Utils, TokenStreamRewriter
};

export { ATN, ATNDeserializer, BailErrorStrategy, InputStream as CharStream, CharStreams, CommonToken, CommonTokenStream, DFA, DiagnosticErrorListener, ErrorListener, FailedPredicateException, InputStream, Interval, IntervalSet, LL1Analyzer, Lexer, LexerATNSimulator, NoViableAltException, ParseTreeListener, ParseTreeVisitor, ParseTreeWalker, Parser, ParserATNSimulator, ParserRuleContext, PredictionContextCache, PredictionMode, RecognitionException, RuleContext, RuleNode, TerminalNode, Token, arrayToString, index_web as default };
