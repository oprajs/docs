...
declare module '@docusaurus/plugin-content-docs' {
  ...
  export type PluginOptions = MetadataOptions &
    ...
    SidebarOptions & {
      ...
      sidebarItemsGenerator: import('@docusaurus/plugin-content-docs/src/sidebars/types').SidebarItemsGeneratorOption;
      /**
  ...
  export type CategoryGeneratedIndexMetadata = Required<
    Omit<
      import('@docusaurus/plugin-content-docs/src/sidebars/types').SidebarItemCategoryLinkGeneratedIndex,
      'type'
    >,
    'title'
  > & {
  ...
  export type PropSidebarItemHtml =
    import('@docusaurus/plugin-content-docs/src/sidebars/types').PropSidebarItemHtml;
  ...
  export type PropSidebarBreadcrumbsItem =
    import('@docusaurus/plugin-content-docs/src/sidebars/types').PropSidebarBreadcrumbsItem;
  ...
  export type LoadedVersion = VersionMetadata & {
    docs: DocMetadata[];
    drafts: DocMetadata[];
    sidebars: import('@docusaurus/plugin-content-docs/src/sidebars/types').Sidebars;
  };
